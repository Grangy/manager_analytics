#!/usr/bin/env node
/**
 * Переимпорт заказов из архивов — исправление испорченной кодировки.
 * Читает zip из UPLOAD_DIR/archive/, извлекает Excel, импортирует с сырыми данными (без fixCyrillicCell).
 *
 * Usage: node scripts/reimport-from-archive.js
 */
...
async function main() {
  console.log('[reimport] Переимпорт из архивов (сырые данные, без конвертации)\n');
